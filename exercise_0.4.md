...
Browser refers to the user's browser
and server refers to the server of the web application the user creates a new note on.
...
sequenceDiagram
    ...
    user enters a new note in the input field and clicks save
    ...
    This causes the browser to send three more GET requests to the server for the dependencies.
